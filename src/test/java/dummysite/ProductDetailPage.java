...
public class ProductDetailPage {
  ...
  public ProductDetailPage(WebDriver driver) {
    this.driver = driver;
    this.shippingCharge = driver.findElement(By.xpath(""));
  }
  ...
  public void ValidateShippingCharge(UserType userType) {
      assertThat(shippingChargeValidationMap.get(userType).test(shippingCharge))
